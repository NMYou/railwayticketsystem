...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($_POST["data"])) {
    header("Location: ticketconfirm(duronto).php");
...
<form id="survey-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
  <h1 id="title">Duronto Booking System</h1>  <br>
...
$query = "INSERT INTO duronto VALUES ('$pname1', '$page1','$pname2', '$page2','$pname3', '$page3',
