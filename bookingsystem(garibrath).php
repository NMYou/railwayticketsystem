...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($_POST["data"])) {
    ...
    header("Location: ticketconfirm(garibrath).php");
...
<form id="survey-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
  <h1 id="title">Garibrath Booking System</h1>  <br>
...
$query = "INSERT INTO garibrath VALUES ('$pname1', '$page1','$pname2', '$page2','$pname3', '$page3',
