...
(7, 'dhruv', 'mehta', '20', '9191919191', 'Male', 'dhruv@gmail.com', '12345678', 16205);
...
CREATE TABLE `ticketbooking` (
  `fp_name` varchar(30) DEFAULT NULL,
  `fp_age` varchar(10) DEFAULT NULL,
  `sp_name` varchar(30) DEFAULT NULL,
  `sp_age` varchar(10) DEFAULT NULL,
  `tp_name` varchar(30) DEFAULT NULL,
  `tp_age` varchar(10) DEFAULT NULL,
  `frp_name` varchar(30) DEFAULT NULL,
  `frp_age` varchar(10) DEFAULT NULL,
  `ftp_name` varchar(30) DEFAULT NULL,
  `ftp_age` varchar(10) DEFAULT NULL
...
INSERT INTO `ticketbooking` (`fp_name`, `fp_age`, `sp_name`, `sp_age`, `tp_name`, `tp_age`, `frp_name`, `frp_age`, `ftp_name`, `ftp_age`) VALUES
('gdsfgs', '25', 'dfgdg', '25', 'zczxczxc', '23', 'fasfsf', '22', 'sfsdfsd', '20');
