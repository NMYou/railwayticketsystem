...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($_POST["data"])) {
    ...
    header("Location: ticketconfirm(geetanjali).php");
...
<form id="survey-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
  <h1 id="title">Geetanjali Booking System</h1>  <br>
...
$query = "INSERT INTO geetanjali VALUES ('$pname1', '$page1','$pname2', '$page2','$pname3', '$page3',
